...
Next step is: [6. Visualization of phylogenetic trees: preparation](https://github.com/Mycology-Microbiology-Center/Phylo2021/blob/main/docs/04.Tree_plotting.md).
