...
- To connect to the server, add your user and password as shown 
<img src="img/WinSCP_HPC_credentials.png" width="500" title="WinSCP user" />![Image]()
...
To connect to to the Connect to HPC:
```bash
